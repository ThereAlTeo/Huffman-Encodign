...
Gestione errori:
Si ritorni in caso di un qualsiasi tipo di errore NULL. Specificare nella relazione gli errori che si possono verificare.
*/
...
/*
Input:
- word: la parola per cui si deve calcolare la funzione Hash
Output:
